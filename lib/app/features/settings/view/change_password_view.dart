          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    'Note:\nMake sure to logout and login again before and after changing your password',
                    style: redHatDisplayRegular14.copyWith(color: fF0000)),
                Visibility(
                  visible: !codeSent,
                  child: Form(
                    key: _formKey,
                            ...
                            onPressed: () async {
                              ...
                              if (_secondFormKey.currentState!.validate()) {
                                try {
                                  ...
                                  await FirebaseAuth.instance.currentUser!
                                      .updatePassword(_confirmPasswordController
                                          .text
                                          .trim());
