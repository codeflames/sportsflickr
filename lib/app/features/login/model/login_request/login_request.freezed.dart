...
abstract class $LoginRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? email, String? password, String? phoneNumber});
}
...
class _$_LoginRequest implements _LoginRequest {
  _$_LoginRequest({this.email, this.password, this.phoneNumber});
  ...
  @override
  String toString() {
    return 'LoginRequest(email: $email, password: $password, phoneNumber: $phoneNumber)';
  }
...
abstract class _LoginRequest implements LoginRequest {
  factory _LoginRequest(
      {final String? email,
      final String? password,
      final String? phoneNumber}) = _$_LoginRequest;
